...
Implementing test case ProverGetsClaim with empty request predicate.
"""
import json
...
class ProverGetsClaimWithEmptyReqPredicate(AnoncredsTestBase):
    ...
    async def execute_test_steps(self):
        ...
        self.steps.add_step("Check returned_claims['predicates'] is empty")
...
if __name__ == '__main__':
    ProverGetsClaimWithEmptyReqPredicate().execute_scenario()
