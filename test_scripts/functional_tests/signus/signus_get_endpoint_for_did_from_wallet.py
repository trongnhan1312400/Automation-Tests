...
class TestGetEndPointForDidFromWallet(SignusTestBase):
    async def execute_test_steps(self):
        ...
        # 4. Set endpoint for 'my_did'.
        self.steps.add_step("Set endpoint for 'my_did'")
...
if __name__ == "__main__":
    TestGetEndPointForDidFromWallet().execute_scenario()
