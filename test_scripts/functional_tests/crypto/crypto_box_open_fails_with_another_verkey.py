...
Implementing test case OpenCryptoBox with another verkey.
"""
...
class OpenCryptoBoxWithAnotherVerkey(CryptoTestBase):
...
if __name__ == '__main__':
    OpenCryptoBoxWithAnotherVerkey().execute_scenario()
