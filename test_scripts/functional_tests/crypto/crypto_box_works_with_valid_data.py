...
class CryptoBoxWorks(CryptoTestBase):
    ...
    async def execute_test_steps(self):
        ...
        result = await utils.perform(self.steps, crypto.crypto_box,
        ...
        if not isinstance(result, Exception):
            ...
            err_message = "Create a crypto box failed."
            self.steps.get_last_step().set_status(Status.FAILED, err_message)
