...
class TestSignWithValidData(SignusTestBase):
    ...
    def __init__(self):
        super().__init__()
        self.expected_signature = bytes([169, 215, 8, 225, 7, 107, 110, 9, 193, 162, 202, 214, 162, 66, 238, 211, 63,
                                         209, 12, 196, 8, 211, 55, 27, 120, 94, 204, 147, 53, 104, 103, 61, 60, 249,
                                         237, 127, 103, 46, 220, 223, 10, 95, 75, 53, 245, 210, 241, 151, 191, 41, 48,
    ...
    async def execute_test_steps(self):
        ...
        signature = await utils.perform(self.steps, signus.sign, self.wallet_handle, my_did, self.message)
