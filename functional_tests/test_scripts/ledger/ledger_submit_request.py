...
class SubmitRequest(TestScenarioBase):
    ...
    async def execute_test_steps(self):
        ...
        message = JsonTemplate.message.format(1496822211362017764, submitter_did, "1", target_did, target_verkey)
        response = await perform(self.steps, ledger.sign_request, self.wallet_handle, submitter_did, message)
        ...
        r2 = response["result"]["identifier"] == expected_response["result"]["identifier"]
